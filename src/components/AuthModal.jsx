  ...
  return (
    <div className="fixed w-screen h-screen top-0 flex justify-center items-center z-50 backdrop-blur-md md:bg-black/10 bg-black/30 px-10  md:px-0 md:text-base">
      <div className="bg-white p-5">
        <h1 className="font-semibold md:text-lg text-base text-center">Oupss caught on 4k <span className="text-2xl">📸</span> you are not authorized to access this page.</h1>
