...
const AuthModal = () => {
  return (
    <div className="fixed w-screen h-screen top-0 flex justify-center items-center z-50 backdrop-blur-md md:bg-black/10 bg-black/30 px-10 text-sm md:px-0 md:text-baseh">
